...
'''
# Setup
follower_list_name = "C:/REU/network_cluster/follower_percentages.csv"
...
def search_followers():
    ...
    while api_accesses < 15:
        ...
        try:
            followers = api.get_followers(user_id = s_userid, count = 200, cursor = cursor)
...
schedule.every(15).minutes.do(search_followers)
