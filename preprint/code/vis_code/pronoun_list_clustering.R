#Author: Liam Tucker
# Used to create Figure 4 and Figure 5
...
# Loading in data
friends_data <- fread("/REU/network_cluster/test_friend_percentages.csv") #, skip=1, col_names = c('user_id', 'has_pronouns', 'followers_sampled', 'raw_match', 'raw_non_match', 'precent_match', 'percent_non_match'))
...
friend_plot
ggsave("/REU/charts/friends_data.png", width = 18, height = 12, units = "in")  
...
# Loading in data
followers_data <- fread("/REU/network_cluster/test_follower_percentages.csv") #, skip=1, col_names = c('user_id', 'has_pronouns', 'followers_sampled', 'raw_match', 'raw_non_match', 'precent_match', 'percent_non_match'))
...
follower_plot
ggsave("/REU/charts/followers_data.png", width = 18, height = 12, units = "in")
